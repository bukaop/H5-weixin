...
ALTER TABLE `wx_act_bargain`
MODIFY COLUMN `show_rate`  int(11) NOT NULL DEFAULT 1 COMMENT '展示比例' AFTER `foucs_user_can_join`;

ALTER TABLE `wx_act_bargain`
ADD COLUMN `short_url`  varchar(255) NULL AFTER `template`;

INSERT INTO `jw_system_project` VALUES ('1a0f957a42514f1a83ca1aab948a6558', 'gzbargain', '新年砍价', '', '', '', 'http://h5.com/jeewx/linksucai/link.do?linkid=1a0f957a42514f1a83ca1aab948a6558', '', 'gzbargain/toIndex.do?openid=${openid}&appid=${appid}', 2, NULL, '', '1', '', '', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `jw_system_auth` VALUES (1541473102, '00d4717a32c010379e8d6ab54d630b0b', '新年砍价', NULL, '0', NULL, '/gzbargain/back/gzWxActBargain/list.do', 'aa735943eb4410368c0028dacd75e20f', 3, '2', NULL, '0', '');

INSERT INTO `weixin_huodong_biz_jwid` VALUES ('ff80808152a2abd20153592394830039', 'wx_act_bargain', '新年砍价主表', '2');
INSERT INTO `weixin_huodong_biz_jwid` VALUES ('ff80808152a2abd20153592394830040', 'wx_act_bargain_awards', '新年砍价中奖表', '1');
INSERT INTO `weixin_huodong_biz_jwid` VALUES ('ff80808152a2abd20153592394830041', 'wx_act_bargain_record', '新年砍价记录表', '1');
INSERT INTO `weixin_huodong_biz_jwid` VALUES ('ff80808152a2abd20153592394830042', 'wx_act_bargain_registration', '新年砍价参与表', '1');
